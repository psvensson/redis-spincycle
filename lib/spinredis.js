...
(function() {
  ...
  spinredis = (function() {
    function spinredis() {
      ...
      this.modelcache = [];
      this.sendredis = require('redis').createClient();
      this.listenredis = require('redis').createClient();
      this.sessionId = null;
      this.objectss = [];
    ...
    spinredis.prototype.setup = function() {
      ...
      return this.listenredis.on('message', (function(_this) {
        return function(channel, replystr) {
          ...
          info = reply.info;
          console.log('got reply messageId ' + reply.messageId + ' status ' + status + ', info ' + info + ' data ' + message + ' outstandingMessages = ' + _this.outstandingMessages.length);
