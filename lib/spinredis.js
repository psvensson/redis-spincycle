...
(function() {
  ...
  spinredis = (function() {
    ...
    spinredis.prototype._emit = function(message) {
      ...
      return this.sendredis.publish('spinchannel_' + this.destinationID, JSON.stringify(message));
    };

    spinredis.prototype.openChannel = function() {
      if (!this.open) {
        this.sendredis.publish('spinchannel_' + this.destinationID, JSON.stringify({
          target: 'listcommands',
    ...
    spinredis.prototype.setup = function(channelID, destinationID) {
